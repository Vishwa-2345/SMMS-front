...
import StudentDetailsSection from "../components/StudentDetailsSection";
import StaffDetailsSection from "../components/StaffDetailsSection";
import ClassDetailsSection from "../components/classDetailsSection";  // <=== Import here
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "staff":
        return <StaffDetailsSection />;
      case "classes":
        return <ClassDetailsSection />;  // <=== Render here
      case "update":
        return (
          <div className="p-6 text-xl font-semibold text-gray-600">
            Update Details Section (Coming Soon)
          </div>
        );
      case "exam":
        return (
          <div className="p-6 text-xl font-semibold text-gray-600">
            Exam Marks Section (Coming Soon)
          </div>
        );
      default:
        return null;
