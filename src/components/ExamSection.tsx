    ...
    setTableData([
      {
        date: "",
        day: "",
        morningSubject: "No Exam",
        morningStaff: "",
        afternoonSubject: "No Exam",
        afternoonStaff: "",
      }
    ]);
  };
            ...
            <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
              <thead className="bg-indigo-600 text-white">
                <tr>
                  <th className="px-4 py-2">Date</th>
                  <th className="px-4 py-2">Day</th>
                  <th className="px-4 py-2">Morning Subject</th>
                  <th className="px-4 py-2">Morning Staff</th>
                  <th className="px-4 py-2">Afternoon Subject</th>
                  <th className="px-4 py-2">Afternoon Staff</th>
                  <th className="px-4 py-2">Delete</th>
                </tr>
              </thead>
              <tbody>
                {tableData.map((row, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="px-4 py-2">
                      <select
                        className="border rounded px-2 py-1 w-full"
                        value={row.morningSubject}
                        onChange={(e) => handleChange(index, "morningSubject", e.target.value)}
                      >
                        {subjectOptions.map((subj) => (
                          <option key={subj} value={subj}>{subj}</option>
                        ))}
                    ...
                    <td className="px-4 py-2">
                      <select
                        className="border rounded px-2 py-1 w-full"
                        value={row.morningStaff}
                        onChange={(e) => handleChange(index, "morningStaff", e.target.value)}
                      >
                    ...
                    <td className="px-4 py-2">
                      <select
                        className="border rounded px-2 py-1 w-full"
                        value={row.afternoonSubject}
                        onChange={(e) => handleChange(index, "afternoonSubject", e.target.value)}
                      >
                        {subjectOptions.map((subj) => (
                          <option key={subj} value={subj}>{subj}</option>
                        ))}
                    ...
                    <td className="px-4 py-2">
                      <select
                        className="border rounded px-2 py-1 w-full"
                        value={row.afternoonStaff}
                        onChange={(e) => handleChange(index, "afternoonStaff", e.target.value)}
                      >
                        <option value="">Select Staff</option>
                        {staffList.map((staff) => (
                          <option key={staff} value={staff}>{staff}</option>
